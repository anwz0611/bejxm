...
/**
 * Created by Zwei  on 2018/5/23.
 * E-Mail Address：592296083@qq.com
 */

public class FristTextDetails extends Activity implements View.OnClickListener{
...
private String biaotia,neirong233;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.frist_text_details);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.duihao:
                ...
                Intent intent = new Intent(FristTextDetails.this,CirclePublishActivity.class);
