...
import com.zyinfo.brj.ui.news.adapter.NewListAdapter;
import com.zyinfo.brj.ui.news.contract.NewsListContract;
import com.zyinfo.brj.ui.news.model.NewsListModel;
import com.zyinfo.brj.ui.news.presenter.NewsListPresenter;
...
public class NewsFrament extends BaseFragment<NewsListPresenter, NewsListModel> implements NewsListContract.View, OnRefreshListener, OnLoadMoreListener {
    ...
    protected void initView() {
        ...
        LogUtils.loge("mNewsId",mNewsId+"");
        LogUtils.loge("mNewsType",mNewsType+"");
