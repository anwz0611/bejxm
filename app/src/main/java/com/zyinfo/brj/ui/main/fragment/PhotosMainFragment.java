...
import com.zyinfo.brj.ui.news.activity.PhotosDetailActivity;
import com.zyinfo.brj.ui.news.contract.PhotoListContract;
import com.zyinfo.brj.ui.news.model.PhotosListModel;
import com.zyinfo.brj.ui.news.presenter.PhotosListPresenter;
...
public class PhotosMainFragment extends BaseFragment<PhotosListPresenter,PhotosListModel> implements PhotoListContract.View ,OnRefreshListener,OnLoadMoreListener{
    ...
    public void initView() {
        ...
        ntb.setTitleText(getString(R.string.xuncha_title));
        adapter=new CommonRecycleViewAdapter<PhotoGirl>(getContext(),R.layout.item_photo) {
            ...
            public void convert(ViewHolderHelper helper,final PhotoGirl photoGirl) {
                ...
                Glide.with(mContext).load(photoGirl.getUrl())
                        ...
                        .placeholder(com.zyinfo.common.R.drawable.ic_image_loading)
                        .error(com.zyinfo.common.R.drawable.ic_empty_picture)
