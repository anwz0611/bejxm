...
public class AssociationInfoActivity extends BaseActivity<AssociationInfoPresenter, AssociationInfoModel> implements AssociationInfoContract.View, OnRefreshListener, OnLoadMoreListener {
    @Bind(R.id.irc)
    IRecyclerView irc;
    @Bind(R.id.loadedTip)
    ...
    public void initView() {
        ...
        WSListAdapter = new CommonRecycleViewAdapter<AssociationInfoBeans>(mContext, R.layout.assinfo_list_item) {
    ...
    public static void startAction(Context mContext) {
        Intent intent = new Intent(mContext, AssociationInfoActivity.class);
