    ...
    protected void onDraw(Canvas canvas) {
		...
		case SHAPE_TRIANGLE:
                ...
                if (mIsLoading) {
                    ...
                    int color= Integer.parseInt(mArgbEvaluator.evaluate(mAnimPercent,mTriangleColor,mCircleColor).toString());
            ...
            case SHAPE_CIRCLE:
                if (mIsLoading) {
                    ...
                    int color= Integer.parseInt(mArgbEvaluator.evaluate(mAnimPercent,mCircleColor,mRectColor).toString()) ;
                    mPaint.setColor(color);
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    int color= Integer.parseInt(mArgbEvaluator.evaluate(mAnimPercent,mRectColor,mTriangleColor).toString());
                    mPaint.setColor(color);
                    Path path = new Path();
